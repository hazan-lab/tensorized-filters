...
from tensorized_filters.models.tensorized_low_rank.config import TensorizedLowRankConfig
from tensorized_filters.models.tensorized_low_rank.model import TensorizedLowRank
...
def main():
    ...
    config = TensorizedLowRankConfig(
        bsz=bsz,
        n_embd=n_embd,
        n_heads=n_heads,
        n_layers=n_layers,
    ...
    model = TensorizedLowRank(config, phi)
    if torch_compile:
    ...
    torch.serialization.add_safe_globals([TensorizedLowRankConfig])
