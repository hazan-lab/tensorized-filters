...
from tensorized_filters.models.tensorized_stu.config import TensorizedSTUConfig
from tensorized_filters.models.tensorized_stu.model import TensorizedSTU
...
def main():
    ...
    model = TensorizedSTU(config, phi)
    if torch_compile:
    ...
    torch.serialization.add_safe_globals([TensorizedSTUConfig])
