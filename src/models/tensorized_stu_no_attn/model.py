...
from tensorized_filters.utils.modules.tensorized_stu import STU
...
from tensorized_filters.layers.tensorized_stu import STULayer
...
class TensorizedSTUNoAttn(PreTrainedModel):
    config_class = TensorizedSTUNoAttnConfig

    def __init__(self, config, phi) -> None:
        super(TensorizedSTUNoAttn, self).__init__(config)
