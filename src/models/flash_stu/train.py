...
from tensorized_filters.models.flash_stu.config import FlashSTUConfig
from tensorized_filters.models.flash_stu.model import FlashSTU
...
def main():
    ...
    dataset = "/scratch/gpfs/mn4560/flash-stu/training/data/fineweb-edu-100B"
